...
X_train, X_test, n_paths_a1, n_paths_a2, n_paths_a3, agent_indicator, se_nodes, true_paths, reverse_ids_sort = gen_paths_agents(seed_n, n_paths, N_train, n_edges, distance_matrix, edges, n_nodes, points, mult)
...
for epoch in range(n_epochs):
    ...
    for it in range(N_train//BS):
        ...
        edges_reg = ((edges_pred - 1.)**2).sum(-1).mean()
        
        
        total_loss = loss + alpha_kl*kl_divergence + 0.1*alpha_kl*edges_reg
